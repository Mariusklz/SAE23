...
urlpatterns = [
    ...
    #URLS Commentaires
    path('commentaire/', views_commentaires.index),
    path('commentaire/ajout/',views_commentaires.ajout),
    path('commentaire/traitement/', views_commentaires.traitement),
    path('commentaire/affiche/<int:id>/',views_commentaires.affiche),
    path('commentaire/update/<int:id>/',views_commentaires.update),
    path('commentaire/updatetraitement/<int:id>/',views_commentaires.updatetraitement),
    path('commentaire/delete/<int:id>/', views_commentaires.delete),
